    ...
    <div className="w-full font-Aeonik overflow-x-hidden">
      ...
      <div className="everything py-10 relative bg-[#D9CEFF]">
        ...
        <div className="w-[90%] mx-auto text-black">
          <div className='text-center py-2 pb-5 space-y-4'>
            <h3 className='text-3xl md:text-5xl  font-bold'>
              Everything You Need, All in One App
            </h3>
            <p className='md:w-4/6 mx-auto font-normal text-[0.93rem] md:text-xl'>From airtime and data to streaming subscriptions and flight bookings, Sureplug simplifies all your payments in one place.</p>
          </div>
      ...
      <div className='w-full bg-[#EFEFEF] py-10 pb-14'>
        <div className='text-center py-2 pb-10 space-y-4'>
          ...
          <p className='md:w-3/6 w-5/6 mx-auto font-normal text-[0.93rem] md:text-xl'>Discover the features that make Sureplug the ultimate solution for all your bill payment needs.</p>
        </div>
      ...
      <div className='w-full pt-14 bg-[#d9ceff1c]'>
        <div className='w-5/6 mx-auto flex flex-wrap md:flex-nowrap gap-y-16 md:gap-y-0 justify-between items-center'>
          <div className="left md:w-3/6 w-full">
            <h3 className='text-3xl md:text-5xl font-bold pb-7'>3 Easy Steps to Get Started with <span className='underline text-[#6840ED] underline-offset-8'>Sureplug</span></h3>

            <ol className='space-y-4 md:space-y-3 list-[value] pl-8 md:pl-5 step-list'>
              <li className='text-black'>
                <h4 className='text-base md:text-2xl font-bold pb-1'>Download and Install the App</h4>
                <p className='text-[0.93rem] md:text-xl font-normal'>Head to your app store, search for "Sureplug," and download it onto your mobile device.</p>
              </li>
              <li className='text-black'>
                <h4 className='text-base md:text-2xl font-bold pb-1'>Sign Up for Free</h4>
                <p className='text-[0.93rem] md:text-xl font-normal'>Launch the app and complete a quick, hassle-free registration with just your basic personal details.</p>
              </li>
              <li className='text-black'>
                <h4 className='text-base md:text-2xl font-bold pb-1'>Add Funds and Pay Bills</h4>
                <p className='text-[0.93rem] md:text-xl font-normal'>Top up your account and instantly begin paying your bills with ease. It’s that straightforward!</p>
              </li>
            </ol>
      ...
      <div className='py-14 w-full'>
        <div className="w-[90%] flex flex-col md:flex-row gap-y-16 md:gap-y-0 justify-between mx-auto bg-[url('./images/footer-bg.png')] bg-center rounded-3xl pt-12 px-12 md:px-20 overflow-hidden">
          <div className="left md:w-3/6 w-full md:self-center space-y-5">
            <h3 className='text-3xl md:text-5xl font-bold text-white text-center md:text-left'>Try <span className='underline underline-offset-4'>Sureplug</span> for free on iOS and Android</h3>
